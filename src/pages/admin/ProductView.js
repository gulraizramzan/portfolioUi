    ...
    <table class="w-auto text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
        ...
        <tbody>
           {product.map((pro)=>(
             ...
             <td class="px-6 py-4">
             <img className="h-10 object-cover rounded-t-xl self-center" src={pro.image} alt="" />
             </td>
             ...
             <td class="flex items-center px-6 py-4">
                 <button onClick={() => handelView(pro._id)} class="font-medium text-blue-600 dark:text-blue-500 hover:underline" >Edit</button>
                 <Link to="/view-product" onClick={() => handleDelete(pro._id)} class="font-medium text-red-600 dark:text-red-500 hover:underline ms-3">Remove</Link>
             </td>
         </tr>
           ))}
