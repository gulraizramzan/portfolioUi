...
const UpdateProduct = () => {
  ...
  const{productTitle,price,discountedPrice,category,image,brand,discription,inventory}=product
  const {id}=useParams()
  useEffect(()=>{
...
const handelChanges=(event)=>{
  ...
  setProduct({
    ...
    const handelUpdateProduct=async(event)=>{
      event.preventDefault();
      let res= await ProductServices.put(`/product/${id}`,product)
    ...
    <form>
        <div className="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
            <div>
                ...
                <input 
                name="productTitle" value={productTitle}
        ...
        <div className='mt-4 mb-4'>
                ...
                <textarea 
                 name="discription" value={discription}
                 onChange={handelChanges}
        ...
        <div className="mt-2 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md">
                <div className="space-y-1 text-center">
                  ...
                  <img src={image} className='mx-auto h-16 w-16'/>
                  <div className="flex text-sm text-gray-600">
                    <label for="file-upload" className="relative cursor-pointer bg-white rounded-md font-medium text-indigo-600 hover:text-indigo-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-indigo-500">
                      ...
                      id="file-upload"  type="text" className="sr-only"/>
                    </label>
