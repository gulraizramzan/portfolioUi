...
{
    LoginApiServices.post("/message",formData).then((res)=>{
    if(res)
    alert("message sent")
    setFormData({
        name: '',
                    ...
                    <ul className="mb-6 md:mb-0">
                        ...
                        <li className="flex">
                            ...
                            <div className="ml-4 mb-4">
                                ...
                                <p className="text-gray-600 dark:text-slate-400">Mobile: +92 (307) 456-7890</p>
                                <p className="text-gray-600 dark:text-slate-400">Mail: gmart@gmail.com</p>
                            </div>
                        </li>
                        <li className="flex">
                            <div className="flex h-10 w-10 items-center justify-center rounded bg-blue-900 text-gray-50">
                        ...
                        <div className="mb-6">
                            <div className="mx-0 mb-1 sm:mb-4">
                                <div className="mx-0 mb-1 sm:mb-4">
                                    ...
                                    type="text" id="name" autocomplete="given-name" placeholder="Your name" className="mb-2 w-full rounded-md border border-gray-400 py-2 pl-2 pr-4 shadow-md dark:text-gray-300 sm:mb-0"  />
                                </div>
                                <div className="mx-0 mb-1 sm:mb-4">
                                    ...
                                    type="email" id="email" autocomplete="email" placeholder="Your email address" className="mb-2 w-full rounded-md border border-gray-400 py-2 pl-2 pr-4 shadow-md dark:text-gray-300 sm:mb-0" />
                                </div>
                            </div>
                            <div className="mx-0 mb-1 sm:mb-4">
                                ...
                                <textarea 
                                 ...
                                 onChange={handelChanges}
                                 name="message"
                                id="message"  cols="30" rows="5" placeholder="Write your message..." className="mb-2 w-full rounded-md border border-gray-400 py-2 pl-2 pr-4 shadow-md dark:text-gray-300 sm:mb-0"></textarea>
                            </div>
                        </div>
