...
{
    const res=LoginApiServices.post("/message",formData).then((res)=>{
    alert("message sent")
    setFormData({
        name: '',
        email:'',
                    ...
                    <ul class="mb-6 md:mb-0">
                        ...
                        <li class="flex">
                            ...
                            <div class="ml-4 mb-4">
                                ...
                                <p class="text-gray-600 dark:text-slate-400">Mobile: +92 (307) 456-7890</p>
                                <p class="text-gray-600 dark:text-slate-400">Mail: gmart@gmail.com</p>
                            </div>
                        </li>
                        <li class="flex">
                            <div class="flex h-10 w-10 items-center justify-center rounded bg-blue-900 text-gray-50">
                        ...
                        <div class="mb-6">
                            <div class="mx-0 mb-1 sm:mb-4">
                                <div class="mx-0 mb-1 sm:mb-4">
                                    ...
                                    type="text" id="name" autocomplete="given-name" placeholder="Your name" class="mb-2 w-full rounded-md border border-gray-400 py-2 pl-2 pr-4 shadow-md dark:text-gray-300 sm:mb-0"  />
                                </div>
                                <div class="mx-0 mb-1 sm:mb-4">
                                    ...
                                    type="email" id="email" autocomplete="email" placeholder="Your email address" class="mb-2 w-full rounded-md border border-gray-400 py-2 pl-2 pr-4 shadow-md dark:text-gray-300 sm:mb-0" />
                                </div>
                            </div>
                            <div class="mx-0 mb-1 sm:mb-4">
                                ...
                                <textarea 
                                 ...
                                 onChange={handelChanges}
                                 name="message"
                                id="message"  cols="30" rows="5" placeholder="Write your message..." class="mb-2 w-full rounded-md border border-gray-400 py-2 pl-2 pr-4 shadow-md dark:text-gray-300 sm:mb-0"></textarea>
                            </div>
                        </div>
                        <div class="text-center">
                            <button 
                            onClick={handelSubmit}
                            type="submit" class="w-full bg-blue-800 text-white px-6 py-3 font-xl rounded-md sm:mb-0">Send Message</button>
                        </div>
                    </form>
                </div>
            </div>
