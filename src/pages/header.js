...
import CarouselCustomNavigation from '../components/Banner.js'
const Header=()=>{
  ...
  const togglePopup = () => {
    ...
    return(
      <>
<nav className=" border-gray-200 dark:bg-gray-900 bg-[url(https://images.pexels.com/photos/3621234/pexels-photo-3621234.jpeg)] bg-no-repeat h-screen bg-cover">
